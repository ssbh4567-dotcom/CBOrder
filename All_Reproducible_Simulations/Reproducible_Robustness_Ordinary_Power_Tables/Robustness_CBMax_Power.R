# ==============================================================================================================
# REPLICATION SCRIPT: Robustness Analysis (Table S7.21 of Supplementary Material --- CBMax Ordinary Power Table)
#
...
# approximately 9 minutes for the CBMax, CB_Max_mix1, CB_Max_mix2, CB_Max_mix3, CB_Max_mix4, and CB_Max_Lap.
#
# *** WARNING ***
...
cat("\n==========================================================================\n")
cat("STARTING ROBUSTNESS ANALYSIS CBMax: Table S7.21 of Supplementary Material (Ordinary Power Tabel)\n")
cat("\n==========================================================================\n")
...
# ==============================================================================
res <- CB_Max(num_datasets, n, 0*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 0    | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 1*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 1    | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 1.25*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 1.25 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 1.5*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 1.5  | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 1.75*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 1.75 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 2*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 2    | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 2.25*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 2.25 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 2.5*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 2.5  | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 2.75*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 2.75 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 3*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 3    | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 3.25*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 3.25 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 3.5*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 3.5  | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 3.75*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 3.75 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 4*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 4    | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 4.25*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 4.25 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 4.5*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 4.5  | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 4.75*mean, sd, k0=2)
cat("Normal (N) | Multiplier (c): 4.75 | Size/Power: ", res, "\n")
res <- CB_Max(num_datasets, n, 5*mean, sd, k0=2)
...
cat("\n--- Distribution: Mix-1 ---\n")
# ==============================================================================
res <- CB_Max_mix1(num_datasets, n, 0*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 0    | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 1*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 1    | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 1.25*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 1.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 1.5*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 1.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 1.75*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 1.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 2*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 2    | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 2.25*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 2.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 2.5*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 2.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 2.75*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 2.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 3*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 3    | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 3.25*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 3.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 3.5*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 3.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 3.75*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 3.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 4*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 4    | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 4.25*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 4.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 4.5*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 4.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 4.75*mean, sd, k0=2)
cat("Mix-1      | Multiplier (c): 4.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix1(num_datasets, n, 5*mean, sd, k0=2)
...
cat("\n--- Distribution: Mix-2 ---\n")
# ==============================================================================
res <- CB_Max_mix2(num_datasets, n, 0*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 0    | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 1*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 1    | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 1.25*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 1.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 1.5*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 1.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 1.75*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 1.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 2*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 2    | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 2.25*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 2.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 2.5*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 2.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 2.75*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 2.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 3*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 3    | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 3.25*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 3.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 3.5*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 3.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 3.75*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 3.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 4*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 4    | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 4.25*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 4.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 4.5*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 4.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 4.75*mean, sd, k0=2)
cat("Mix-2      | Multiplier (c): 4.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix2(num_datasets, n, 5*mean, sd, k0=2)
...
cat("\n--- Distribution: Mix-3 ---\n")
# ==============================================================================
res <- CB_Max_mix3(num_datasets, n, 0*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 0    | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 1*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 1    | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 1.25*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 1.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 1.5*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 1.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 1.75*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 1.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 2*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 2    | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 2.25*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 2.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 2.5*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 2.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 2.75*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 2.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 3*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 3    | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 3.25*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 3.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 3.5*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 3.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 3.75*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 3.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 4*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 4    | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 4.25*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 4.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 4.5*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 4.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 4.75*mean, sd, k0=2)
cat("Mix-3      | Multiplier (c): 4.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix3(num_datasets, n, 5*mean, sd, k0=2)
...
cat("\n--- Distribution: Mix-4 ---\n")
# ==============================================================================
res <- CB_Max_mix4(num_datasets, n, 0*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 0    | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 1*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 1    | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 1.25*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 1.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 1.5*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 1.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 1.75*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 1.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 2*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 2    | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 2.25*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 2.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 2.5*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 2.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 2.75*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 2.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 3*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 3    | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 3.25*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 3.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 3.5*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 3.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 3.75*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 3.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 4*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 4    | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 4.25*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 4.25 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 4.5*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 4.5  | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 4.75*mean, sd, k0=2)
cat("Mix-4      | Multiplier (c): 4.75 | Size/Power: ", res, "\n")
res <- CB_Max_mix4(num_datasets, n, 5*mean, sd, k0=2)
...
# ==============================================================================
res <- CB_Max_Lap(num_datasets, n, 0*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 0    | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 1*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 1    | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 1.25*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 1.25 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 1.5*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 1.5  | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 1.75*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 1.75 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 2*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 2    | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 2.25*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 2.25 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 2.5*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 2.5  | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 2.75*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 2.75 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 3*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 3    | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 3.25*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 3.25 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 3.5*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 3.5  | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 3.75*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 3.75 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 4*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 4    | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 4.25*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 4.25 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 4.5*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 4.5  | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 4.75*mean, sd, k0=2)
cat("Laplace    | Multiplier (c): 4.75 | Size/Power: ", res, "\n")
res <- CB_Max_Lap(num_datasets, n, 5*mean, sd, k0=2)
...
cat("\n==========================================================================\n")
cat("TABLE S7.21 REPLICATION COMPLETE\n")
cat("==========================================================================\n")
